            ...
            <div className="max-w-[900px] mx-auto w-full flex justify-between items-center">
              <div className="flex gap-24 items-center">
                <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-all duration-300">
                  ...
                  <span className="text-lg font-semibold text-cyan-400">BOOS Builder Bot</span>
                </Link>
              </div>

              <div className="flex gap-8">
                <ButtonUI variant="tertiary" className="hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300">
                  Start Building
                </ButtonUI>
              </div>
            </div>
